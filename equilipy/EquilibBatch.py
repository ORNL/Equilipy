...
def _equilib_batch(Database:dict,NTP:dict,Unit:list=['K','atm','moles'],ListOfPhases:list=None):
...
def _equilib_batch_input(database,conditions,Unit,ListOfPhases,nPerBatch):
    """
    ...
    for i in range(fullrange[0], fullrange[1], nPerBatch):
        ...
        res.append( [database,subcondition,Unit,ListOfPhases] ) 
    return res
...
def equilib_batch(Database:dict,NTP:dict,Unit:list=['K','atm','moles'],ListOfPhases:list=None,nCPU:int=os.cpu_count(),nPerBatch:int=1):
    '''
    ...
    '''
    # Get a batch input
    arg =_equilib_batch_input(Database,NTP,Unit,ListOfPhases,nPerBatch)
...
# def equilib_batch_hpc(Database:dict,NTP:dict,UnitIn:list=['K','atm','moles'],UnitOut:list=None,ListOfPhases:list=None,nCPU:int=os.cpu_count(),nPerBatch:int=1):
#     '''
#     Calculate phase equlibria for multiple NTP conditions.
#     ----------------------------------------------------------------------------------------------------------------
...
#         UnitOut = UnitIn.copy() 
#     # Get a batch input
#     arg =_equilib_batch_input(Database,NTP,UnitIn,UnitOut,ListOfPhases,nPerBatch)
