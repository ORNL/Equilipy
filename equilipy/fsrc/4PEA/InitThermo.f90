...
!
    ...
    nMaxParam      = nParamMax
!
    ! The universal gas constant used below is calculated using Avogadro's # (6.02214076E+23) to 8
    ! sig. fig.'s and Boltzmann's constant (1.380649E-23) to 8 sig. fig.'s.  dIdealConstant is
    ! therefore computed to 7 sig. fig.'s.  Note: SOLGASMIX uses 8.31433.
    dIdealConstant = 8.3144626182D0
!
    ! Machine precision:
    dEPS = 1D-14
!
