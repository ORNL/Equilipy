...
!
    ...
    elseif (INFOThermo == 37) then
        print *, 'DEBUG: Failed to calculate the number of independent elements (matrix_rank) during minimization'
        print *, 'See CheckSYSElements.f90'
    ...
    elseif (INFOThermo == 44) then
        print *, 'DEBUG: Gradient descent failed to converge.'
