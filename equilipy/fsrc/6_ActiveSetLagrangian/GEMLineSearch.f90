...
!
    ...
    !   06/24/2026      S.Y. Kwon       Recorded line-search norm and step diagnostics without changing
    !                                    the existing damped Newton acceptance logic.
    !   06/24/2026      S.Y. Kwon       Tested a tighter early-exit residual for active SUBOM phases.
!   06/25/2026      S.Y. Kwon       Matched the line-search early-exit tolerance to postprocess
!                                    fixed-assemblage convergence.
!   06/28/2026      S.Y. Kwon       Required strict norm descent before accepting a legacy
!                                    Lagrangian line-search step.
!   06/29/2026      S.Y. Kwon       Added a guarded binary SUBG/SUBQ pair-exchange correction after
!                                    ordinary no-descent line searches.
