...
:::{note}
The macOS installers are not yet notarized by Apple, so the first launch
shows a warning that Equilipy could not be verified. Click **Done** (not
*Move to Trash*), then use one of the following options:
