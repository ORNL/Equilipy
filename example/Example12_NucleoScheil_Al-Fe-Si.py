...
if __name__ == "__main__":
    ...
    data_scheil_x = np.array(dict_scheil["LIQUID_endmembers_w_Si"]) * 100
    data_scheil_y = np.array(dict_scheil["LIQUID_endmembers_w_Fe"]) * 100
    ...
    data_nucleoscheil_x = (
        np.array(dict_nucleoscheil["LIQUID_endmembers_w_Si"]) * 100
    )
    data_nucleoscheil_y = (
        np.array(dict_nucleoscheil["LIQUID_endmembers_w_Fe"]) * 100
    )
